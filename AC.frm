VERSION 5.00
Begin VB.Form formAddChronicles 
   Caption         =   "Add a New Chronicle"
   ClientHeight    =   5760
   ClientLeft      =   19395
   ClientTop       =   7815
   ClientWidth     =   14430
   ...
   End
End
Attribute VB_Name = "formAddChronicles"
...
If art_name = "" Then
    strr = "chronicle's title is empty."
    GoTo hata1:
    End If
...
makedir (CurrentDir & "\chronicles\" & date_format)
makedir (CurrentDir & "\chronicles\" & date_format & "\" & from_name)

ChDrive Left$(CurrentDir & "\chronicles\" & date_format & "\" & from_name & "\", 1)
ChDir (CurrentDir & "\chronicles\" & date_format & "\" & from_name & "\")

Open art_name & "_" & aut_name & "_" & art_date & "." & "txt" For Output As 1
Close

Open art_name & "_" & aut_name & "_" & art_date & "_" & "txt" & ".afd" For Output As 1
    Write #1, from_name, date_format, art_name, aut_name, "", art_date, art_keys, "txt", review_score, review_status, "chronicles"
Close

status (Text2.Text & " is added as chronicle file")
...
ResizeControls formAddChronicles
End Sub
